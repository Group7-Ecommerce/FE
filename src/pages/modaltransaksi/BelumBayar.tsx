...
const Belumbayar = () => {
  ...
  return (
    <>
      <div>
        <button className="text-lg hover:text-[#03AC0E]" onClick={openModal}>
          Belum bayar
        </button>
      </div>
              ...
              >
                <Dialog.Panel className="w-full transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="flex flex-col text-start justify-center ">
                    <p className="text-xl font-bold -mt-40 ml-72">Asus</p>
                    <p className="ml-72">Qty:1 </p>
                    <p className="ml-72">Rp.12.000.000</p>
                  </div>

                  <p className="text-end">Order masuk pembayaran</p>
                </Dialog.Panel>
              </Transition.Child>
            </div>
          </div>
